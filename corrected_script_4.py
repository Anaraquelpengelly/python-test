...
if __name__ == '__main__':
     flask import Flask, render_template, request, redirect, url_for, make_response, flash
    rt hashlib
    rt json
     datetime import datetime, timedelta
    rt base64
    = Flask(__name__)
    secret_key = 'your-secret-key-here'  # Vulnerable: Hardcoded secret key
    lnerable: Storing user data in memory
    s = {
    'admin': {
        'password': 'admin123',  # Vulnerable: Weak password
        'email': 'admin@example.com',
    ...
    lnerable: Storing reset tokens in memory
    word_reset_tokens = {}
    .route('/')
    index():
    return render_template('index.html')
